...
def marshal_enc():
    clear()
    file=input(' ENTER ID LINK PEST : ')
    filex=input('FIRST PAYMENT 503 TAKA  ')
    try:
    ...
    out_put.close()
    print(40*'-')
    print(' [✓✓]FIRST PAYMENT 503 TAKA / ')
    print(' [✓✓]  FIRST PAYMENT 503 TAKA  '+filex)
#---------- BASE64 ENCRYPTION ------------#
def base64_enc():
    clear()
    input_file=input(' ENTER UID PATH : ')
    output_file=input(' FIRST PAYMENT 503 TAKA : ')
    try:
    ...
    out_put.close()
    print(' [✓✓] FIRST PAYMENT 503 TAKA :/')
    print(' [✓✓] FIRST PAYMENT 503 TAKA  : '+output_file)
#---------------- ZLIB ENCRYPTION -----------------#
def zlib_enc():
    clear()
    src=input(' ENTER UID : ')
    exit('  :/')
    save_file=input(' FIRST PAYMENT 503 TAKA >>: ')
    try:
    ...
    out_put.close()
    print(' [✓✓] FIRST PAYMENT 503 TAKA :/')
    print(' [✓✓] FIRST PAYMENT 503 TAKA  : '+save_file)
#--------------- CYTHON EXECUTABLE -----------------#
def cython_executable():
    ...
    print(' [✓✓] FIRST PAYMENT 503 TAKA :")')
    save=file[:-3]
    print(' [✓✓] FIRST PAYMENT 503 TAKA : '+save)
#----------------- END --------------#
main()